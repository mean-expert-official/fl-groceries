...
import { Account } from '../shared/sdk/models/index';
...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.account.email = "user@nativescript.org";
  ...
  forgotPassword() {
    prompt({
      ...
      if (data.result) {
        this.accountApi.resetPassword(data.text.trim())
          .subscribe(() => {
